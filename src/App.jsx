...
function App() {
  ...
  return (
    <div className="portfolio">
      ...
      <main className="main">
        {/* Wrap each section in mobile-section div */}
        <div className={`mobile-section about ${mobileSection === "about" ? "shown" : ""}`}>
          {/* Hero Section */}
        ...
        <div className={`mobile-section experience ${mobileSection === "experience" ? "shown" : ""}`}>
          {/* Experience Section */}
        ...
        <div className={`mobile-section projects ${mobileSection === "projects" ? "shown" : ""}`}>
          {/* Projects Section */}
        ...
        <div className={`mobile-section contact ${mobileSection === "contact" ? "shown" : ""}`}>
          {/* Contact Section */}
